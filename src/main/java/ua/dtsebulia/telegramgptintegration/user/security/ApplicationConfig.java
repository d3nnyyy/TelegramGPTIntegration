...
public class ApplicationConfig {
    ...
    /**
     * Creates a CorsFilter bean for configuring CORS.
     *
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "https://telegram-gpt-integration-by-d3n41kk.azurewebsites.net"));
